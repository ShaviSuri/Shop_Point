...
import com.shavi.shoppoint.models.SingleProductModel;
            ...
            protected void populateViewHolder(final MovieViewHolder viewHolder, final SingleProductModel model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("product",new GenericProductModel(model.getPrdesc(),model.getPrid(),model.getPrimage(),model.getPrname(),Float.parseFloat(model.getPrprice())));
