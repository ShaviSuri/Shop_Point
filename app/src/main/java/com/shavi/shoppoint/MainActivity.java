...
import com.shavi.shoppoint.networksync.CheckInternetConnection;
import com.shavi.shoppoint.prodcutscategory.Bags;
import com.shavi.shoppoint.prodcutscategory.Calendars;
import com.shavi.shoppoint.prodcutscategory.Cards;
import com.shavi.shoppoint.prodcutscategory.Keychains;
import com.shavi.shoppoint.prodcutscategory.Stationary;
import com.shavi.shoppoint.prodcutscategory.Tshirts;
import com.shavi.shoppoint.usersession.UserSession;
                        ...
                        switch (position) {
                            ...
                            case 9:
                                new EasyFeedback.Builder(MainActivity.this)
                                        .withEmail("shaviofficial@gmail.com")
                                        .withSystemInfo()
                                        .build()
                                        .start();
                                break;
